...
const imageMeta = [
  { width: 1600, height: 900, alt: "Todo app homepage screenshot" },
  { width: 1600, height: 900, alt: "Add todo screenshot" },
  { width: 1600, height: 900, alt: "Edit todo screenshot" },
];
...
export default function TodoAppProject() {
  ...
  // Track if screen is wide enough (md: 768px+)
          ...
          (resolve) => {
            ...
            img.onload = () => {
              if (img.naturalWidth && img.naturalHeight) {
                ...
                // fallback to provided meta or 16:9
                const meta = imageMeta[idx] || { width: 16, height: 9 };
                resolve({
                  width: meta.width,
                  height: meta.height,
  ...
  // Helper to get width/height for current image, fallback to 1600x900 if not loaded yet
  ...
  // Sections for content and images
  const imageSection = (
    <section
      className={`flex flex-col items-center w-full md:w-auto ${isWide ? "md:pl-20" : "md:pr-20"}`}
      style={{
        flexBasis: "75%",
        flexGrow: 1,
        minWidth: 0,
  ...
  const contentSection = (
    <section
      className={isWide ? "md:pr-20" : "md:pl-20"}
      style={{
        textAlign: "left",
        flexBasis: "25%",
        flexGrow: 0,
    ...
    >
      ...
      >
        <li>Hourly and weekly planning</li>
        <li>Subtasks and breakdowns</li>
        <li>Drag-and-drop for time management</li>
        <li>Minimal, fast, and desktop-optimized</li>
      </ul>
    </section>
  );

  // Render sections in swapped order if wide, else normal order
  return (
    <div
      style={{
        minHeight: "100vh",
